...
export default class News {
  ...
  #createNews() {
    ...
    <div class="news">
      ...
      <div class="news__description">A cup of brewed coffee represents a contribution of up to 1.8 grams of fiber of the recommended.</div>
      <div class="news__inner">
        ${this.newsItems.map(newsItem => `
          <div class="news__card">
            <div class="news__image" style="background-image: url(/src/components/news/images/${newsItem.image})"></div>
